...
sys.path.append("/home/"+USERNAME+"/Voitures_Infos/Tkinter/GPS")    #On indique au systeme ou ce situe le repertoire "Services" dans l'Appareil
...
def la_Vitesse_GPS():
    try:
        ...
        Affichage_KMH = "Votre Vitesse : 00 Km\h"
        return Affichage_KMH                                                    #On retourne la valeur pour une utilisation ulterieure (UI)
