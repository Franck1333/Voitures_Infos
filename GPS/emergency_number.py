...
#------------------------------------------------------------
from GPSoI import recuperation_coordonees_ip_V1
#------------------------------------------------------------
import unicodedata #Cette blibliothèque permet de travailler avec du contenue contenant des accents

def numero_urgence():

    city,ZIP,continent_name = recuperation_coordonees_ip_V1()                                           #Obtention du continent de l'utilisateur
    ...
    print("Pour",continent_name)                                                                                                #Message Console indiquant le continent
    print("Numeros d'Urgence disponible pour votre Region:",emergency_phone_number[continent_name])                             #Message Console indiquant le numéro d'urgence à composer

    tel_urgence = emergency_phone_number[continent_name]                                                                        #Enregistrment du numéro d'urgence dans une variable en fonction de la localisation de l'utilisateur

    #print(tel_urgence) #Numero(s) de Telephone(s) determiné(s) #TEST - DEBUG

    tk_tel_urgence = "Le(s) Numero(s) d'Urgence(s) dans votre continent: " + str(tel_urgence)                                   #Mise en page UI
