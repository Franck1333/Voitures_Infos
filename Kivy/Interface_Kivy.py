...
sys.path.append("/home/"+USERNAME+"/Voitures_Infos/Kivy/Services")  #On indique au systeme ou ce situe le repertoire "Services" dans l'Appareil
sys.path.append("/home/"+USERNAME+"/Voitures_Infos/Kivy/GPS")
...
class MaDisposition(BoxLayout, Screen):
    ...
    Voiture_PNG = "/home/"+USERNAME+"/Voitures_Infos/Kivy/Services/images_defaut/Voiture.png" #Pour indiquer le chemin ou se trouve l'Image dans l'Ordinateur
...
class Play_Media(AnchorLayout,GridLayout, Screen):
    ...
    FondImage = "/home/"+USERNAME+"/Voitures_Infos/Kivy/Services/images_defaut/cm_champ2.jpg" #Pour indiquer le chemin ou se trouve l'Image dans l'Ordinateur 
#---------------------------------------------------------------------------------------------------------------------------------------
