...
def getMap():
    ...
    with open('/home/'+USERNAME+'/Voitures_Infos/Kivy/GPS/MAP_downloads/map.jpg', 'wb') as f:
...
def getMap_ISS():
    ...
    response = requests.get(url)
    with open('/home/'+USERNAME+'/Voitures_Infos/Kivy/GPS/MAP_downloads/map_ISS.jpg', 'wb') as f:
        f.write(response.content)
...
def getMapInterface():
    ...
    MAPjpg = PhotoImage(file='/home/'+USERNAME+'/Voitures_Infos/Kivy/GPS/MAP_downloads/map_ISS.jpg')                             #Chargement de la MAP
