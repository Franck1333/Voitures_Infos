...
setup(
    ...
    install_requires=["pyserial==3.2.1","geopy==1.20.0","Kivy==1.11.1","matplotlib==3.0.3","numpy==1.22.0","pandas==0.25.1","pynmea2==1.15.0","pyowm==2.9.0","requests==2.22.0","Unidecode==1.1.1","urllib3==1.26.5","wifi==0.3.8"], #Get the Dependencies from Pypi (pip install)
